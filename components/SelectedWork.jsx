  ...
  const featured = [
    {
      ...
      title: "Roley.ai",
      slug: "roley",
      role: t("selectedWork.featured.roleyRole"),
      year: t("selectedWork.featured.roleyYear"),
    ...
    },
    {
      ...
      title: "WobJay",
      slug: "wobjay",
      role: t("selectedWork.featured.wobjayRole"),
      year: t("selectedWork.featured.wobjayYear"),
    ...
    },
    {
      ...
      role: t("selectedWork.featured.styleguideRole"),
      year: t("selectedWork.featured.styleguideYear"),
  ...
  return (
    <section className="relative pb-24 pt-8">
      <div className="mb-10 flex items-end justify-between">
        <div>
          <div className="section-eyebrow">{t("selectedWork.eyebrow")}</div>
          <h2 className="font-display text-4xl italic tracking-tight text-ink xl:text-6xl">{t("selectedWork.headline")}</h2>
        </div>
        <Link
          href="/work"
        ...
        >
          <span className="link-underline">{t("selectedWork.allWork")}</span>
              ...
              <div className="card-surface overflow-hidden">
                <div className="relative aspect-[16/11] overflow-hidden bg-surface-raised">
                  ...
                  <div className="absolute left-4 top-4">
                    <span className="font-mono text-[10px] uppercase tracking-[0.2em] text-ink/80">[ {p.num} ]</span>
                  </div>
