...
const DownloadCV = ({ size }) => {
  const { t, locale } = useT();
  const href = locale === "es" ? PERSONAL_INFO.curriculumsLinks.spanish : PERSONAL_INFO.curriculumsLinks.english;
  const sizeClasses =
  ...
  return (
    ...
    >
      ...
      >
        <span className="relative z-10 font-semibold">{t("common.downloadCV")}</span>
